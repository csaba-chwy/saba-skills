...
- Log enrichment varies by environment and record type. Production samples lacked service and correlation fields, while staging included records with `dt.entity.service` and short `trace_id` values but no `span_id`.
