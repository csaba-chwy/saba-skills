...
- Probe dimension values before filtering. Sampled series differed in whether outcome and routing tags were populated; Boolean-like tags may also be strings in one context and Booleans in another.
